...
print(pp)
ggsave(pp,filename = "maize_p.tiff",width = 12,height = 10)
dev.off()
getwd()
  }else{
  ...
  geom_bar(mapping = aes(x = Chromosome))
print(pp)
ggsave(pp,filename = "teosinte_p.tiff",width = 12,height = 10)
dev.off()
getwd()
  }}
rm(i)
...
for(i in 1:2){
  ...
  print(pp)
  ggsave(pp,filename = "maize_distribution.tiff",width = 10,height = 12)
  dev.off()
  getwd()
          }else{
  pp=ggplot(data = teosinte_fang_et_al_genotypes, mapping=aes(x=Chromosome, y=Position))+
     geom_point(alpha=0.1)
  print(pp)
  ggsave(pp,filename = "teosinte_distribution.tiff",width = 10,height = 12)
  dev.off()
  getwd()
               }
             }
...
print(pp)
ggsave(pp,filename = "maize_proportion.tiff",width = 14,height = 10)
dev.off()
getwd()
          }else{
            ...
            geom_bar(mapping = aes(x =Sample, fill=allele))
            print(pp)
            ggsave(pp,filename = "teosinte_proportion.tiff",width = 14,height = 10)
            dev.off()
            getwd()
                }
              }
